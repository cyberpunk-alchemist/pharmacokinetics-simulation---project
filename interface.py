...
class Interface(ctk.CTk):
    def __init__(self):
        ...
        self.entry_1.insert(0,str(self.simulator.start_t))
        ...
        self.entry_2.insert(0,str(self.simulator.stop_t))
        ...
        self.entry_3.insert(0,str(self.simulator.nsteps))
        ...
        self.entry_4.insert(0,str(self.simulator.D))
        ...
        self.entry_5.insert(0,str(self.simulator.Vd))
        ...
        self.entry_6.insert(0,str(self.simulator.dose_int))
        ...
        self.entry_7.insert(0,str(self.simulator.model_params["k_e"]))
        ...
        self.entry_8.insert(0,str(self.simulator.model_params["k_a"]))
        ...
        run_button.grid(row=100, column=1, padx=20, pady=20)

        self.error_lable = ctk.CTkLabel(self, text="", text_color="red")
        self.error_lable.grid(row=100, column=2, padx=10, pady=20, sticky="w")
